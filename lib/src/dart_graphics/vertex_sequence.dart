import 'package:dart_graphics/src/dart_graphics/math.dart';
...
class VertexDistance implements XY {
  ...
  bool isEqual(VertexDistance val) {
    final bool ret = (dist = DartGraphicsMath.CalcDistance(x, y, val.x, val.y)) >
        DartGraphicsMath.vertex_dist_epsilon;
    if (!ret) dist = 1.0 / DartGraphicsMath.vertex_dist_epsilon;
    return ret;
  }
}
