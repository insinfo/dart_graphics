//
// DartGraphicsContext provides global configuration and default settings
// for the DartGraphics rendering library.
...
/// Graphics mode configuration for DartGraphics rendering
class DartGraphicsGraphicsMode {
...
class PlatformConfig {
  ...
  DartGraphicsGraphicsMode graphicsMode;

  PlatformConfig({
    DartGraphicsGraphicsMode? graphicsMode,
  }) : graphicsMode = graphicsMode ?? DartGraphicsGraphicsMode();
}
...
/// Global context for DartGraphics rendering configuration.
/// Provides default fonts, platform detection, and configuration settings.
class DartGraphicsContext {
  ...
  static DartGraphicsGraphicsMode get graphicsMode => _config.graphicsMode;
  ...
  /// Initializes DartGraphicsContext with the specified fonts.
  ///
