/// CanvasGradient - AGG implementation of HTML5 Canvas gradient
/// 
...
class AggCanvasGradient implements ICanvasGradient {
  ...
  AggCanvasGradient.linear(double x0, double y0, double x1, double y1)
  ...
  AggCanvasGradient.radial(double x0, double y0, double r0, double x1, double y1, double r1)
  ...
  AggCanvasGradient.conic(double startAngle, double x, double y)
  ...
  /// Creates an AGG SpanGradient for rendering
  SpanGradient? createSpanGradient() {
    ...
    if (_type == _GradientType.linear) {
      ...
      // Conic gradient - not directly supported by AGG, fallback to linear
