/// dart_graphics Canvas 2D Example
///
/// This example demonstrates the HTML5-style Canvas 2D API for dart_graphics.
...
void main() {
  print('dart_graphics Canvas 2D API Example');
  print('=' * 40);

  // Create a canvas
  final canvas = DartGraphicsCanvas(800, 600);
  ...
  final roundRect = DartGraphicsPath2D();
  ...
  final outputPath = 'test/tmp/dartgraphics_canvas2d_example.png';
