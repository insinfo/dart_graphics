...
void main() {
  ...
  group('Basic Triangle Tests (t11-t16)', () {
    test('t11 - Basic triangle fill', () {
      ...
      PngEncoder.saveImage(buffer, 'test/tmp/agg_test_11.png');
      expect(File('test/tmp/agg_test_11.png').existsSync(), isTrue);

      // Compare with reference image
      final match = compareImages('test/tmp/agg_test_11.png', 'resources/image/agg_test_11.png');
    ...
    test('t12 - Triangle with clip box', () {
      ...
      PngEncoder.saveImage(buffer, 'test/tmp/agg_test_12.png');
      expect(File('test/tmp/agg_test_12.png').existsSync(), isTrue);

      final match = compareImages('test/tmp/agg_test_12.png', 'resources/image/agg_test_12.png');
      expect(match, isTrue, reason: 'Output should match reference image');
    });
    ...
    test('t13 - Aliased triangle (binary scanline)', () {
      ...
      PngEncoder.saveImage(buffer, 'test/tmp/agg_test_13.png');
      expect(File('test/tmp/agg_test_13.png').existsSync(), isTrue);

      final match = compareImages('test/tmp/agg_test_13.png', 'resources/image/agg_test_13.png');
      expect(match, isTrue, reason: 'Output should match reference image');
    });
    ...
    test('t14 - Triangle with gamma', () {
      ...
      PngEncoder.saveImage(buffer, 'test/tmp/agg_test_14.png');
      expect(File('test/tmp/agg_test_14.png').existsSync(), isTrue);

      final match = compareImages('test/tmp/agg_test_14.png', 'resources/image/agg_test_14.png');
      expect(match, isTrue, reason: 'Output should match reference image');
    });
    ...
    test('t15 - Path with stroke', () {
      ...
      PngEncoder.saveImage(buffer, 'test/tmp/agg_test_15.png');
      expect(File('test/tmp/agg_test_15.png').existsSync(), isTrue);

      final match = compareImages('test/tmp/agg_test_15.png', 'resources/image/agg_test_15.png');
      expect(match, isTrue, reason: 'Output should match reference image');
    });
    ...
    test('t16 - Path with stroke (no clip)', () {
      ...
      PngEncoder.saveImage(buffer, 'test/tmp/agg_test_16.png');
      expect(File('test/tmp/agg_test_16.png').existsSync(), isTrue);

      final match = compareImages('test/tmp/agg_test_16.png', 'resources/image/agg_test_16.png');
      expect(match, isTrue, reason: 'Output should match reference image');
    });
  });
